...
public class BottomSheetDialogFragmentSearchRequestPickRegDateFrom extends BottomSheetDialogFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.okButton:{
                ...
                SearchFragment.setReg_dateFrom(date);
