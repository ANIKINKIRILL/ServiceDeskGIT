package com.example.admin.oracletest.ui.request_details;
...
/**
 * For detail information about current request that user picks
 */

public class DetailRequestActivity extends DaggerAppCompatActivity {
